...
copy. The note is the argument; this earns the read.*
...
The note: <https://glassontin.github.io/civic-kernel/docs/glp-note.md>
The public telling: <https://glassontin.github.io/civic-kernel/findings.html>
The door: <https://github.com/GlassOnTin/civic-kernel/issues>

---

*[Before sending: attach `docs/glp-note.pdf` (two sides of A4); add name, contact and
addressee. If the note is edited first, regenerate the PDF:
`pandoc docs/glp-note.md -s --css=$PWD/docs/letter.css --metadata title=" " -o /tmp/n.html
&& google-chrome --headless --no-pdf-header-footer --print-to-pdf=docs/glp-note.pdf file:///tmp/n.html`]*
