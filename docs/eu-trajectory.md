...
| S1 | + adopt the transparency log ([§3.4](https://glassontin.github.io/civic-kernel/#s3-4 "Every action is committed to an append-only log; altering past records breaks cryptographic consistency across all distributed copies.")) | strike | conditional | 25/30 | strains | inferred |
| S2 | + verifiable ballots for EP elections and the ECI ([§3.2](https://glassontin.github.io/civic-kernel/#s3-2 "Your ballot is sealed before submission and counted without being decrypted; you can verify it was counted, but cannot prove how you voted.")) | strike | conditional | 25/30 | strains | inferred |
...
([§3.1](https://glassontin.github.io/civic-kernel/#s3-1 "Prove you are on the roster and have not already participated, without revealing your identity or building a personal profile.")).
...
cannot make anyone obey ([§12](https://glassontin.github.io/civic-kernel/#s12 "The boundaries of the design, including explicit exclusions and unresolved challenges.")).
...
exists to express ([§13](https://glassontin.github.io/civic-kernel/#s13 "Many underlying components exist in isolation; the goal is integrating them into an accessible, user-verifiable client application.")).
