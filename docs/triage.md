...
_Generated by `tools/triage.py` over `triage/cases.json` (36 cases: 28 accepted, 8 refused)._
...
| 7 | grenfell-warnings-ignored ⚠ legible-not-remedied | 6 | 3 × 2 | inaction_no_artifact, record_absent | **encoded** (`grenfell-warnings-ignored`) |
| 8 | maternity-harm-downgraded ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **candidate** |
| 9 | nhs-data-access-opaque | 6 | 3 × 2 | access_gated, record_absent | **encoded** (`nhs-data-access-opaque`) |
| 10 | procurement-vip-lane ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, record_absent | **encoded** (`procurement-vip-lane`) |
| 11 | regulator-inaction ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`regulator-inaction`) |
| 12 | single-justice-procedure-opaque ⚠ legible-not-remedied | 6 | 3 × 2 | documentary_gate, record_absent | **candidate** |
| 13 | carers-allowance-overpayment ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact, record_absent | **candidate** |
| 14 | citizenship-deprivation-basis ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`citizenship-deprivation-basis`) |
| 15 | criminal-disclosure-failure ⚠ legible-not-remedied | 4 | 2 × 2 | access_gated, record_absent | **encoded** (`criminal-disclosure-failure`) |
| 16 | dwp-death-reviews-secret ⚠ legible-not-remedied | 4 | 2 × 2 | access_gated, record_absent | **candidate** |
| 17 | facial-recognition-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`facial-recognition-no-basis`) |
| 18 | ministerial-standards-unenforced ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact | **encoded** (`ministerial-standards-unenforced`) |
| 19 | ofsted-single-word-judgment ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`ofsted-single-word-judgment`) |
| 20 | police-vetting-ignored ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact, record_absent | **candidate** |
| 21 | protest-conditions-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`protest-conditions-no-basis`) |
| 22 | removal-without-legible-warrant | 4 | 2 × 2 | record_absent | **encoded** (`removal-without-legible-warrant`) |
| 23 | send-ehcp-refusals ⚠ legible-not-remedied | 4 | 2 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`send-ehcp-refusals`) |
| 24 | us-civil-asset-forfeiture ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent, documentary_gate | **candidate** |
| 25 | voter-id | 4 | 2 × 2 | documentary_gate | **encoded** (`voter-id`) |
| 26 | drc-medical-detention ⚠ legible-not-remedied | 3 | 3 × 1 | record_absent | **encoded** (`drc-medical-detention`) |
| 27 | government-by-whatsapp ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **encoded** (`government-by-whatsapp`) |
| 28 | infected-blood-coverup ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **encoded** (`infected-blood-coverup`) |

### Recommended to encode next

The highest-leverage cases not yet built as scenarios:

- **maternity-harm-downgraded** (score 6) — Maternity units grade avoidable harm and deaths as low-risk to avoid scrutiny, and families raising concerns are not heard, so a pattern of failure stays invisible until an inquiry reconstructs it.  
  _Lead: Ockenden Review (Shrewsbury & Telford); East Kent (Kirkup); Nottingham maternity review_
- **single-justice-procedure-opaque** (score 6) — Hundreds of thousands are convicted in private under the Single Justice Procedure — TV licence, DVLA, rail fares — with no hearing, no legible reasons, and often no real chance to respond.  
  _Lead: Single Justice Procedure; Post Office SJP prosecutions; Transform Justice; Magistrates' Association concerns_
- **carers-allowance-overpayment** (score 4) — Carers unknowingly earn a few pounds over the Carer's Allowance limit; the DWP, holding the real-time earnings data that would flag it, says nothing for years, then claws back tens of thousands and prosecutes.  
  _Lead: DWP Carer's Allowance overpayments (Guardian investigation 2024); NAO; Work and Pensions Committee_
