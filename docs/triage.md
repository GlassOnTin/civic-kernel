...
- **marketplace-delisting-no-rule** (score 4) — Sellers suspended and apps delisted with no rule cited and revenue held; the EU had to legislate a statement of reasons because platforms gave none.  
  _Lead: Platform-to-Business Regulation (EU) 2019/1150, arts 4-5; CMA, Mobile ecosystems market study (2022)_
- **union-ballot-employer-interference** (score 4) — Workplace recognition ballots run inside the employer's power — mandatory meetings, watched infrastructure, retaliation outside the booth — and a rerun arrives only after a regulator finds the interference, against a fear no rerun removes.  
  _Lead: NLRB, Amazon Bessemer rerun order (2021); TULR(C)A Sch A1 recognition ballots (CAC)_
