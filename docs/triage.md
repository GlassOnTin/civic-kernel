...
| 8 | maternity-harm-downgraded ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`maternity-harm-downgraded`) |
...
- **dwp-death-reviews-secret** (score 4) — The DWP conducts internal reviews into deaths of benefit claimants but withholds or heavily redacts them, so the pattern linking its decisions to deaths cannot be seen.  
  _Lead: DWP Internal Process Reviews (FOI disclosures); Independent Case Examiner; NAO_
