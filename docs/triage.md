...
| 11 | citizenship-deprivation-basis | 4 | 2 × 2 | record_absent | **candidate** |
...
- **citizenship-deprivation-basis** (score 4) — Citizenship is stripped by the Home Secretary on a national-security basis the person cannot fully see or contest in time.  
  _Lead: British Nationality Act s.40; deprivation cases; closed-material procedure_
