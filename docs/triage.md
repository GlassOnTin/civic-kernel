...
_Generated by `tools/triage.py` over `triage/cases.json` (51 cases: 39 accepted, 2 closed as covered, 10 excluded)._
...
| 6 | social-housing-priority-banding-downgrade | 9 | 3 × 3 | inaction_no_artifact, access_gated, record_absent | **candidate** |
| 7 | automated-welfare-reasons | 6 | 3 × 2 | record_absent | **encoded** (`automated-welfare-reasons`) |
| 8 | exam-algorithm-downgrade ⚠ legible-not-remedied | 6 | 3 × 2 | record_absent, pattern_of_lawful_acts | **encoded** (`exam-algorithm-downgrade`) |
| 9 | family-contact-order-unenforced ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`family-contact-order-unenforced`) |
| 10 | family-court-secrecy ⚠ legible-not-remedied | 6 | 3 × 2 | access_gated, pattern_of_lawful_acts | **encoded** (`family-court-secrecy`) |
| 11 | gig-deactivation-no-reasons | 6 | 3 × 2 | record_absent | **encoded** (`gig-deactivation-no-reasons`) |
| 12 | grenfell-warnings-ignored ⚠ legible-not-remedied | 6 | 3 × 2 | inaction_no_artifact, record_absent | **encoded** (`grenfell-warnings-ignored`) |
| 13 | maternity-harm-downgraded ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact, record_single_authored | **encoded** (`maternity-harm-downgraded`) |
| 14 | minutes-written-by-the-winner ⚠ legible-not-remedied | 6 | 3 × 2 | record_single_authored | **encoded** (`minutes-written-by-the-winner`) |
| 15 | nhs-data-access-opaque | 6 | 3 × 2 | access_gated, record_absent | **encoded** (`nhs-data-access-opaque`) |
| 16 | procurement-vip-lane ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, record_absent | **encoded** (`procurement-vip-lane`) |
| 17 | regulator-inaction ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`regulator-inaction`) |
| 18 | single-justice-procedure-opaque ⚠ legible-not-remedied | 6 | 3 × 2 | documentary_gate, record_absent | **encoded** (`single-justice-procedure-opaque`) |
| 19 | who-told-the-minister ⚠ legible-not-remedied | 6 | 3 × 2 | record_absent, record_single_authored | **encoded** (`who-told-the-minister`) |
| 20 | asylum-move-on-evictions | 6 | 2 × 3 | inaction_no_artifact, documentary_gate, record_absent | **candidate** |
| 21 | carers-allowance-overpayment ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact, record_absent | **encoded** (`carers-allowance-overpayment`) |
| 22 | citizenship-deprivation-basis ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`citizenship-deprivation-basis`) |
| 23 | coop-governance-opaque | 4 | 2 × 2 | pattern_of_lawful_acts, record_absent | **encoded** (`coop-governance-opaque`) |
| 24 | criminal-disclosure-failure ⚠ legible-not-remedied | 4 | 2 × 2 | access_gated, record_absent | **encoded** (`criminal-disclosure-failure`) |
| 25 | dwp-death-reviews-secret ⚠ legible-not-remedied | 4 | 2 × 2 | access_gated, record_absent | **encoded** (`dwp-death-reviews-secret`) |
| 26 | facial-recognition-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`facial-recognition-no-basis`) |
| 27 | marketplace-delisting-no-rule | 4 | 2 × 2 | record_absent | **encoded** (`marketplace-delisting-no-rule`) |
| 28 | ministerial-standards-unenforced ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact | **encoded** (`ministerial-standards-unenforced`) |
| 29 | ofsted-single-word-judgment ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`ofsted-single-word-judgment`) |
| 30 | police-vetting-ignored ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact, record_absent | **encoded** (`police-vetting-ignored`) |
| 31 | protest-conditions-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`protest-conditions-no-basis`) |
| 32 | removal-without-legible-warrant | 4 | 2 × 2 | record_absent | **encoded** (`removal-without-legible-warrant`) |
| 33 | send-ehcp-refusals ⚠ legible-not-remedied | 4 | 2 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`send-ehcp-refusals`) |
| 34 | union-ballot-employer-interference ⚠ legible-not-remedied | 4 | 2 × 2 | pattern_of_lawful_acts | **encoded** (`union-ballot-employer-interference`) |
| 35 | us-civil-asset-forfeiture ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent, documentary_gate | **encoded** (`us-civil-asset-forfeiture`) |
| 36 | voter-id | 4 | 2 × 2 | documentary_gate | **encoded** (`voter-id`) |
| 37 | drc-medical-detention ⚠ legible-not-remedied | 3 | 3 × 1 | record_absent | **encoded** (`drc-medical-detention`) |
| 38 | government-by-whatsapp ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **encoded** (`government-by-whatsapp`) |
| 39 | infected-blood-coverup ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **encoded** (`infected-blood-coverup`) |

### Recommended to encode next

The highest-leverage cases not yet built as scenarios:

- **social-housing-priority-banding-downgrade** (score 9): Local housing authorities silently downgrade medical or homelessness priority bands on bidding registers during automated batch reviews, with no written reasons or contemporaneous log entry.

  _Lead: Local Government and Social Care Ombudsman public interest reports on housing allocation delays (Birmingham, Lambeth, Southwark, 2023-2025)_
- **asylum-move-on-evictions** (score 6): Recognized refugees face immediate eviction and destitute cliff-edges under the 28-day move-on notice rule due to absence of automated data transfer between Home Office status grant and local authority homelessness duties.

  _Lead: British Red Cross / Refugee Council, Keys to the City (2024); High Court judicial reviews on move-on notice period failures_

### Closed as covered: already on the map

Real process issues addressed by a verifiable record through scenarios already encoded. In bug triage this corresponds to a duplicate status, noting the existing cases that cover the issue.
...
Not defects that a checkable record can address; each is closed with an explanatory reason.
