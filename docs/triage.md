...
| 7 | grenfell-warnings-ignored ⚠ legible-not-remedied | 6 | 3 × 2 | inaction_no_artifact, record_absent | **candidate** |
...
- **grenfell-warnings-ignored** (score 6) — Residents' and experts' fire-safety warnings are made repeatedly and ignored; the ignoring leaves no record to challenge until it is too late.  
  _Lead: Grenfell Tower Inquiry; Grenfell Action Group warnings (pre-2017)_
