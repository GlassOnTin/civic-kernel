...
| 13 | carers-allowance-overpayment ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact, record_absent | **encoded** (`carers-allowance-overpayment`) |
...
- **us-civil-asset-forfeiture** (score 4) — Police seize cash and property from people never charged with a crime; to get it back the owner must prove the property's innocence, a burden many cannot meet.  
  _Lead: US civil asset forfeiture; Institute for Justice 'Policing for Profit'; Timbs v Indiana (2019) — non-UK_
