...
| 12 | single-justice-procedure-opaque ⚠ legible-not-remedied | 6 | 3 × 2 | documentary_gate, record_absent | **encoded** (`single-justice-procedure-opaque`) |
...
- **police-vetting-ignored** (score 4) — Repeated warnings, allegations and vetting flags about a serving officer are recorded and not acted on until he commits grave crimes; the failure to act leaves no reviewable trace.  
  _Lead: Angiolini Inquiry (Couzens); David Carrick case; HMICFRS vetting super-complaint_
