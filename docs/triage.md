...
| 15 | ofsted-single-word-judgment ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`ofsted-single-word-judgment`) |
...
- **infected-blood-coverup** (score 3) — Patients are given contaminated blood, not told for years, and the documents that would prove it are lost or destroyed.  
  _Lead: Infected Blood Inquiry (Langstaff, final report 2024)_
