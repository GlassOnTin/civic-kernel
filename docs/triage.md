...
_Generated by `tools/triage.py` over `triage/cases.json` (29 cases: 22 accepted, 7 refused)._
...
| 8 | nhs-data-access-opaque | 6 | 3 × 2 | access_gated, record_absent | **encoded** (`nhs-data-access-opaque`) |
| 9 | procurement-vip-lane ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, record_absent | **encoded** (`procurement-vip-lane`) |
| 10 | regulator-inaction ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`regulator-inaction`) |
| 11 | citizenship-deprivation-basis ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`citizenship-deprivation-basis`) |
| 12 | criminal-disclosure-failure ⚠ legible-not-remedied | 4 | 2 × 2 | access_gated, record_absent | **encoded** (`criminal-disclosure-failure`) |
| 13 | facial-recognition-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`facial-recognition-no-basis`) |
| 14 | ministerial-standards-unenforced ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact | **encoded** (`ministerial-standards-unenforced`) |
| 15 | ofsted-single-word-judgment ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **candidate** |
| 16 | protest-conditions-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`protest-conditions-no-basis`) |
| 17 | removal-without-legible-warrant | 4 | 2 × 2 | record_absent | **encoded** (`removal-without-legible-warrant`) |
| 18 | send-ehcp-refusals ⚠ legible-not-remedied | 4 | 2 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **candidate** |
| 19 | voter-id | 4 | 2 × 2 | documentary_gate | **encoded** (`voter-id`) |
| 20 | drc-medical-detention ⚠ legible-not-remedied | 3 | 3 × 1 | record_absent | **candidate** |
| 21 | government-by-whatsapp ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **encoded** (`government-by-whatsapp`) |
| 22 | infected-blood-coverup ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **candidate** |

### Recommended to encode next

The highest-leverage cases not yet built as scenarios:

- **ofsted-single-word-judgment** (score 4) — A school inspection reduces everything to a single word with no legible reasoning and no timely appeal, with catastrophic consequences.  
  _Lead: Ruth Perry inquest (2023); Ofsted single-word grades abolished (2024)_
- **send-ehcp-refusals** (score 4) — Councils unlawfully refuse or delay special-educational-needs assessments; each refusal defensible alone, the systemic pattern invisible.  
  _Lead: Local Government & Social Care Ombudsman SEND reports; IPSEA_
- **drc-medical-detention** (score 3) — Hospitals detain medically-cleared patients — and hold the bodies of the deceased — until unpaid bills are settled, with no lawful warrant and no route to contest the confinement.  
  _Lead: Transnational Justice Initiative / 9BR Chambers; UN Working Group Against Arbitrary Detention (DRC debt-detention, 2025); via CrowdJustice — non-UK_
