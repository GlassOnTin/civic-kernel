...
| 19 | coop-governance-opaque | 4 | 2 × 2 | pattern_of_lawful_acts, record_absent | **encoded** (`coop-governance-opaque`) |
...
| 23 | marketplace-delisting-no-rule | 4 | 2 × 2 | record_absent | **encoded** (`marketplace-delisting-no-rule`) |
...
| 30 | union-ballot-employer-interference ⚠ legible-not-remedied | 4 | 2 × 2 | pattern_of_lawful_acts | **encoded** (`union-ballot-employer-interference`) |
