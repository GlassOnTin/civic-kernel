...
_Generated by `tools/triage.py` over `triage/cases.json` (44 cases: 35 accepted, 9 refused)._
...
| 5 | shareholder-vote-plumbing | 9 | 3 × 3 | record_absent, pattern_of_lawful_acts | **candidate** |
...
| 10 | gig-deactivation-no-reasons | 6 | 3 × 2 | record_absent | **candidate** |
...
| 12 | maternity-harm-downgraded ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`maternity-harm-downgraded`) |
| 13 | nhs-data-access-opaque | 6 | 3 × 2 | access_gated, record_absent | **encoded** (`nhs-data-access-opaque`) |
| 14 | procurement-vip-lane ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, record_absent | **encoded** (`procurement-vip-lane`) |
| 15 | regulator-inaction ⚠ legible-not-remedied | 6 | 3 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`regulator-inaction`) |
| 16 | single-justice-procedure-opaque ⚠ legible-not-remedied | 6 | 3 × 2 | documentary_gate, record_absent | **encoded** (`single-justice-procedure-opaque`) |
| 17 | carers-allowance-overpayment ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact, record_absent | **encoded** (`carers-allowance-overpayment`) |
| 18 | citizenship-deprivation-basis ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`citizenship-deprivation-basis`) |
| 19 | coop-governance-opaque | 4 | 2 × 2 | pattern_of_lawful_acts, record_absent | **candidate** |
| 20 | criminal-disclosure-failure ⚠ legible-not-remedied | 4 | 2 × 2 | access_gated, record_absent | **encoded** (`criminal-disclosure-failure`) |
| 21 | dwp-death-reviews-secret ⚠ legible-not-remedied | 4 | 2 × 2 | access_gated, record_absent | **encoded** (`dwp-death-reviews-secret`) |
| 22 | facial-recognition-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`facial-recognition-no-basis`) |
| 23 | marketplace-delisting-no-rule | 4 | 2 × 2 | record_absent | **candidate** |
| 24 | ministerial-standards-unenforced ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact | **encoded** (`ministerial-standards-unenforced`) |
| 25 | ofsted-single-word-judgment ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent | **encoded** (`ofsted-single-word-judgment`) |
| 26 | police-vetting-ignored ⚠ legible-not-remedied | 4 | 2 × 2 | inaction_no_artifact, record_absent | **encoded** (`police-vetting-ignored`) |
| 27 | protest-conditions-no-basis | 4 | 2 × 2 | record_absent | **encoded** (`protest-conditions-no-basis`) |
| 28 | removal-without-legible-warrant | 4 | 2 × 2 | record_absent | **encoded** (`removal-without-legible-warrant`) |
| 29 | send-ehcp-refusals ⚠ legible-not-remedied | 4 | 2 × 2 | pattern_of_lawful_acts, inaction_no_artifact | **encoded** (`send-ehcp-refusals`) |
| 30 | union-ballot-employer-interference ⚠ legible-not-remedied | 4 | 2 × 2 | pattern_of_lawful_acts | **candidate** |
| 31 | us-civil-asset-forfeiture ⚠ legible-not-remedied | 4 | 2 × 2 | record_absent, documentary_gate | **encoded** (`us-civil-asset-forfeiture`) |
| 32 | voter-id | 4 | 2 × 2 | documentary_gate | **encoded** (`voter-id`) |
| 33 | drc-medical-detention ⚠ legible-not-remedied | 3 | 3 × 1 | record_absent | **encoded** (`drc-medical-detention`) |
| 34 | government-by-whatsapp ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **encoded** (`government-by-whatsapp`) |
| 35 | infected-blood-coverup ⚠ legible-not-remedied | 3 | 3 × 1 | record_destroyed | **encoded** (`infected-blood-coverup`) |

### Recommended to encode next

The highest-leverage cases not yet built as scenarios:

- **shareholder-vote-plumbing** (score 9) — Corporate elections run through custodian chains nobody can verify end to end: a Delaware court found more facially valid vote claims than shares in existence, and proxy contests turn on recounts nobody outside the plumbing can check.  
  _Lead: In re Dole Food Co. Stockholder Litigation (Del. Ch. 2017); Procter & Gamble/Trian proxy contest recount (2017)_
- **gig-deactivation-no-reasons** (score 6) — Gig workers dismissed by automated decision with no reason served and nothing to appeal; an explanation took years and a foreign court order under data-protection law.  
  _Lead: Drivers v Uber BV and Ola Cabs (Amsterdam Court of Appeal, 2023), GDPR art 22_
- **coop-governance-opaque** (score 4) — A mutual owned by millions ran its member democracy through tiers no member could follow or check; the structure was found manifestly dysfunctional only at the point of near-collapse.  
  _Lead: Myners, Report of the Independent Governance Review, Co-operative Group (2014)_
