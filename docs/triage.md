...
| 12 | criminal-disclosure-failure | 4 | 2 × 2 | access_gated, record_absent | **candidate** |
...
- **criminal-disclosure-failure** (score 4) — Police and prosecutors fail to disclose evidence to the defence; material that would clear the accused exists but is never handed over.  
  _Lead: R v Liam Allan (2017, collapsed); HMCPSI / CJI disclosure reviews_
