...
- **T5's challenge and T4's silent re-vote compose — and decided the election.** In the
  ...
  sealed forever.
- **36 scenarios**, each cross-validated against the waist schemas and each anchored to
  documented real-world precedents (92 verified citations — the schema requires them: no
  attack without a cited precedent): 28 strain, 7 break, 1 holds. The one hold is
