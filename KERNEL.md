...
- **T5's challenge and T4's silent re-vote compose — and decided the election.** In the
  ...
  sealed forever.
- **56 scenarios**, each cross-validated against the waist schemas and each anchored to
  documented real-world precedents (153 verified citations — the schema requires them: no
  attack without a cited precedent): 47 strain, 8 break, 1 holds. The one hold is
