...
- **T5's challenge and T4's silent re-vote compose — and decided the election.** In the
  ...
  sealed forever.
- **38 scenarios**, each cross-validated against the waist schemas and each anchored to
  documented real-world precedents (98 verified citations — the schema requires them: no
  attack without a cited precedent): 30 strain, 7 break, 1 holds. The one hold is
